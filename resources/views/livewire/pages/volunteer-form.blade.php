...
<div class="container volunteer-form pt-5">
    ...
    <div class="card mb-3 shadow mx-auto" style="max-width: 600px;">
        ...
        <div class="card-body">
            <form wire:submit.prevent="submit">
                ...
                <div class="mb-2">
                    ...
                    <textarea class="form-control" wire:model="message" id="message" rows="3" placeholder="Write your motivation here"></textarea>
